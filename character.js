...
async function getUsers() {
    const rawResponse = await fetch("https://gateway.marvel.com:443/v1/public/characters/" + ID + "?ts=12345&apikey=1cb8f124cfacf199eb92aa85d67dd9b3&hash=7867bd775a8bd67600140ee13563af61");
    ...
    document.getElementById("users-list").innerHTML += `
            ...
            <div class="item">
               ...
               <h1 class="films">Comics starring ${response.data.results[0].name}</h1>
            </div>
            `;
    for (let i = 0; i < 20; i++) {
        document.getElementById("users-list").innerHTML += `
